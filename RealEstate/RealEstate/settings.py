...
SECRET_KEY = 'django-insecure-$cd@7+ga1!0e5=!%a_yo$jm3w(%kea=iq7v$vlk3fjptstm1b&'
...
EMAIL_PORT = '587'
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'msmwillschoolacct@gmail.com'
EMAIL_HOST_PASSWORD = 'vomp hpvz lezy vhzd'
