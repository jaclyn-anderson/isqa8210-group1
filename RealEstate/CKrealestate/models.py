...
class Property(models.Model):
    ...
    property_photo1 = models.ImageField(upload_to='uploads/', null=False, blank=False, default='default_photo.jpg')
...
class Contact(models.Model):
    ...
    contact_email = models.EmailField(max_length=300, default='example@gmail.com')
